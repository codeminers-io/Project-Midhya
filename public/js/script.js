$(document).ready(function () {
	...
	var bot = '<div class="chatCont" id="chatCont">' +
		...
		'<img src="img/logo.png" class="bot_p_img">' +
		'<div class="close">' +
		...
		'<img src="img/logo.png" class="img-circle img-profile">' +
		'</div><!--col-hgt end-->' +
		'<div class="col-hgt">' +
		'<div class="chat-txt">' +
		'' +
	...
	function send(text) {
		...
		$.ajax({
			url: 'https://midhya.herokuapp.com:5005/webhooks/rest/webhook', //  RASA API
			type: 'POST',
			headers: {
